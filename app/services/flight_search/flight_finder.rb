  ...
  class FlightFinder
    class << self
      ...
      def find_in_database(flight_number:)
        Commands::MakeDatabaseJson.execute(flight_number: flight_number)
      end

      def fetch_from_adsbdb_api(flight_number:)
        adsbdb_result = Commands::MakeAdsbdbJson.execute(flight_number: flight_number)
      ...
      def error_response(message:)
        Commands::MakeFailJson.execute(error_message: message)
      end
    end
  end
end
